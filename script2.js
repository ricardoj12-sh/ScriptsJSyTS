...
function obtenerActividades(actividades) {
    return new Promise(function (resolve) {
        actividades.forEach(function (actividad, index) {
            setTimeout(function () {
                console.log("Actividad ".concat(index + 1, ": ").concat(actividad));
...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var _a, nombre, actividades, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, obtenerUsuario()];
                case 1:
                    _a = _b.sent(), nombre = _a.nombre, actividades = _a.actividades;
                    console.log("Usuario: ".concat(nombre));
                    return [4 /*yield*/, obtenerActividades(actividades)];
                case 2:
                    _b.sent(); // Esperamos a que se impriman todas las actividades
